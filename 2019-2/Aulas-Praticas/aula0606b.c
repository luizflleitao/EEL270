 ...
 *
 * $Author: luiz.leitao $
 * $Date: 2019/09/30 00:47:37 $
 * $Log: aula0606b.c,v $
 * Revision 1.2  2019/09/30 00:47:37  luiz.leitao
 * Alteracoes adicionais no arquivo.
 *
 * Revision 1.1  2019/09/20 04:25:56  luiz.leitao
 * Initial revision
 *
 */
...
main(int argc, char **argv)
{
  ...
  (char) (*(*(argv + 1) + (PIS_PASEP_COM_DIGITO_VERIFICADOR_COM_HIFEN - 1)) - '0');
