 ...
 *
 * $Author: luiz.leitao $
 * $Date: 2019/09/30 00:46:25 $
 * $Log: aula0605b.c,v $
 * Revision 1.2  2019/09/30 00:46:25  luiz.leitao
 * Alteracoes adicionais no arquivo.
 *
 * Revision 1.1  2019/09/20 03:54:15  luiz.leitao
 * Initial revision
 *
 */
...
/* Inclusao dos arquivo de cabecalho da biblioteca padrao da linguagem. */
...
main(int argc, char **argv)
{
  ...
  resultado = GerarDigitoVerificadorPisPasep(pisPasep, digitoVerificador);
