 ...
 *
 * $Author: luiz.leitao $
 * $Date: 2019/11/26 17:01:54 $
 * $Log: lfllUmlTestGetNcursesUserInterfaceMessage.c,v $
 * Revision 1.1  2019/11/26 17:01:54  luiz.leitao
 * Initial revision
 *
 */
...
main(int argc, char **argv)
{
  ...
  if (argc != LFLL_UML_NUMBER_OF_ARGUMENTS)
  {
    ...
    move(3, 1);
    printw("Use: %s <language value> <user interface message value>", *argv);
    move(5, 1);
  ...
  if (*(*(argv + 1) + 0) == '-')
  {
    ...
    move(4, 1);
    printw("Use: %s <language value> <user interface message value>\n\n\n\n", *argv);
    move(6, 1);
    printw("Press any key to exit.");
    refresh();
    getch();
  ...
  {
    move(2, 1);
    printw("Local Error #%i: invalid user interface message value.", LFLL_UML_INVALID_USER_INTERFACE_MESSAGES_NUMBER);
    move(3, 1);
    printw("Use: %s <language value> <user interface message value>", *argv);
    move(5, 1);
    printw("Press any key to exit.");
  ...
  lfllUmlResult = LfllUmlGetNcursesUserInterfaceMessage((char) lfllUmlLanguageValue, (char) lfllUmlUserInterfaceMessageValue);
...
/* $RCSfile: lfllUmlTestGetNcursesUserInterfaceMessage.c,v $ */
