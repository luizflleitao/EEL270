 ...
 *
 * $Author: luiz.leitao $
 * $Date: 2019/03/29 06:30:51 $
 * $Log: aula0107.c,v $
 * Revision 1.1  2019/03/29 06:30:51  luiz.leitao
 * Initial revision
 *
 */
...
main(int argc, char **argv)
{
  ...
  printf("\n\n\t\"- Tipos Basicos combinados com Modificadores de Sinal e com\n");
  printf("\t   Modificadores de Largura -\"\n\n");

  printf("signed short int:\n\t\t\t\t\t\t\t%lu byte%s", (long unsigned) sizeof(signed short int), sizeof(signed short int) > 1 ? "s\n\n" : "\n\n");

  printf("unsigned short int:\n\t\t\t\t\t\t\t%lu byte%s", (long unsigned) sizeof(unsigned short int), sizeof(unsigned short int) > 1 ? "s\n\n" : "\n\n");

  printf("signed long int:\n\t\t\t\t\t\t\t%lu byte%s", (long unsigned) sizeof(signed long int), sizeof(signed long int) > 1 ? "s\n\n" : "\n\n");

  printf("unsigned long int:\n\t\t\t\t\t\t\t%lu byte%s", (long unsigned) sizeof(unsigned long int), sizeof(signed long int) > 1 ? "s\n\n" : "\n\n");

  printf("signed long long int:\n\t\t\t\t\t\t\t%lu byte%s", (long unsigned) sizeof(signed long long int), sizeof(signed long long int) > 1 ? "s\n\n" : "\n\n");

  printf("unsigned long long int:\n\t\t\t\t\t\t\t%lu byte%s", (long unsigned) sizeof(unsigned long long int), sizeof(unsigned long long int) > 1 ? "s\n\n" : "\n\n");
